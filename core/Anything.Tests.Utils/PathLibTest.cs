    ...
    public class PathLibTest
    {
        ...
        public void ExtnameTest()
        {
            var extnameTests = new[]
            {
                ...
                new[] { ".file.", "." }, new[] { ".file..", "." }, new[] { "..", "" }, new[] { "../", "" },
                new[] { "..file.ext", ".ext" }, new[] { "..file", ".file" }, new[] { "..file.", "." }, new[] { "..file..", "." },
                new[] { "...", "." }, new[] { "...ext", ".ext" }, new[] { "....", "." }, new[] { "file.ext/", ".ext" },
                new[] { "file.ext//", ".ext" }, new[] { "file/", "" }, new[] { "file//", "" }, new[] { "file./", "." },
                new[] { "file.//", "." }, new[] { ".\\", "" }, new[] { "..\\", ".\\" }, new[] { "file.ext\\", ".ext\\" },
                new[] { "file.ext\\\\", ".ext\\\\" }, new[] { "file\\", "" }, new[] { "file.\\", ".\\" }, new[] { "file.\\\\", ".\\\\" }
            };
