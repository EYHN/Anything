...
public class RegularFileType : ObjectGraphType<RegularFileEntry>
{
    public RegularFileType(IEnumerable<FileFieldEndpoint> fieldAddons)
    {
        Name = "RegularFile";
        Description =
        ...
        IsTypeOf = obj => obj is RegularFileEntry;
    }
}
