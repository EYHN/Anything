...
namespace StagingBox.Database.Orm
{
    public abstract class OrmDatabaseProvider
    {
        ...
        /// <summary>
        /// Release an object. Usually triggered by the database provider calling <see cref="OrmTransaction.Release"/> , then the database should delete the object.
        /// If the changed object contains other objects, you need to call <see cref="OrmTransaction.Release"/> recursively.
        /// </summary>
